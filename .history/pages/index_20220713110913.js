      ...
      <main className="min-h-screen bg-neutral-700">
        <div className={`w-full h-screen flex items-center justify-center top-0 left-0 right-0 bottom-0 m-auto`}>
          <div className={`transform scale-150 flex gap-4`}>
            <br/>
            <label>Name:</label>
            <input className={`px-2 ml-2`} type="text" name="item1" defaultValue={shopCart.name} onChange={(e) => handleChange(e)}/>
            <br></br>
            <input className={`px-2 ml-2`} type="text" name="age" defaultValue={shopCart.name} onChange={(e) => handleChange(e)}/>
            <br></br>
