  ...
  return (
    <>
      <main className="min-h-screen bg-neutral-700">
        <div className={`w-full h-screen flex flex-col items-center justify-center top-0 left-0 right-0 bottom-0 m-auto`}>
          <div className={`transform scale-150 flex gap-4 bg-white text-black p-4`}>
            ...
            <p>I am: <input type="number" name="age" min="1" max="100" /></p>
          </div>
        </div>
      </main>
    </>
