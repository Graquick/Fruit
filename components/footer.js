...
function Footer() {
  ...
  return (
    <div>
      ...
      className="max-w-[1400px] w-[90%] m-auto backdrop-blur-sm shadow-sm flex flex-col gap-4 py-2 items-center justify-between px-8 justify-center items-center text-xs uppercase dark:text-gray-300 lg:w-full lg:text-[0.45rem] "
       // className="footer"
      >
        <IconSet />
